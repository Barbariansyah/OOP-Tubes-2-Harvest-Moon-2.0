...
public class GameWindow extends JFrame implements KeyListener{
    ...
    public GameWindow(){  
        ...
        JLabel infolabel = new JLabel("<html>Player Info<br><br></html>", SwingConstants.CENTER);
    ...
    public void updateView(){
        ...
        //Update player info
        try {
            waterlabel.setText("<html>Water Container : "+String.valueOf(Player.getInstance().getWaterContainer())+"</html>");
            moneylabel.setText("<html>Money : "+String.valueOf(Player.getInstance().getMoney())+"</html>");
